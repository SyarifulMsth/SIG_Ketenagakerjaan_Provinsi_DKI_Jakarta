...
var style_TingkatPengangguranTerbukaProvinsiDKIJakarta2020_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("TPT 2020");
    var labelText = "";
    size = 0;
    ...
    if (value > 2.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 8.000000 && value <= 12.270000) {
            style = [ new ol.style.Style({
