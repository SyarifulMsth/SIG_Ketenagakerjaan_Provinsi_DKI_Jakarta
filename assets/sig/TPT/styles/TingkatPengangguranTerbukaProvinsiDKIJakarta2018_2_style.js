...
var style_TingkatPengangguranTerbukaProvinsiDKIJakarta2018_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("TPT 2018");
    var labelText = "";
    size = 0;
    ...
    if (value > 2.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4.000000 && value <= 5.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 5.500000 && value <= 7.010000) {
            style = [ new ol.style.Style({
